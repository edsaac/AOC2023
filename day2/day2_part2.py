# How to make all games possible?
# Answer: 72706
...
class Game:
    ...
    def __post_init__(self):
        ...
        self.minset = Subset(
            max([s.red for s in self.subsets]),
            max([s.green for s in self.subsets]),
            max([s.blue for s in self.subsets])
        )

        self.power = self.minset.red * self.minset.green * self.minset.blue
...
def main():
    ...
    print("Answer: ", sum([game.power for game in list_of_games]))
